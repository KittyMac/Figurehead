...
public extension Pamphlet.Private.Figurehead.Ui {
    ...
    static func UiAlertHtml() -> String {
        let fileOnDiskPath = "/Volumes/Development/Development/chimerasw3/Figurehead/Resources/private/figurehead/ui/ui.alert.html"
...
public extension Pamphlet.Private.Figurehead.Ui {
    ...
    static func UiAlertJs() -> String {
        let fileOnDiskPath = "/Volumes/Development/Development/chimerasw3/Figurehead/Resources/private/figurehead/ui/ui.alert.js"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
...
public extension Pamphlet.Private.Figurehead.Ui {
    ...
    static func UiAllHtml() -> String {
        let fileOnDiskPath = "/Volumes/Development/Development/chimerasw3/Figurehead/Resources/private/figurehead/ui/ui.all.html"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
...
public extension Pamphlet.Private.Figurehead.Ui {
    ...
    static func UiAllJs() -> String {
        let fileOnDiskPath = "/Volumes/Development/Development/chimerasw3/Figurehead/Resources/private/figurehead/ui/ui.all.js"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
...
public extension Pamphlet.Private.Figurehead.Ui {
    ...
    static func UiButtonHtml() -> String {
        let fileOnDiskPath = "/Volumes/Development/Development/chimerasw3/Figurehead/Resources/private/figurehead/ui/ui.button.html"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
...
public extension Pamphlet.Private.Figurehead.Ui {
    ...
    static func UiButtonJs() -> String {
        let fileOnDiskPath = "/Volumes/Development/Development/chimerasw3/Figurehead/Resources/private/figurehead/ui/ui.button.js"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
...
public extension Pamphlet.Private.Figurehead.Ui {
    ...
    static func UiGridHtml() -> String {
        let fileOnDiskPath = "/Volumes/Development/Development/chimerasw3/Figurehead/Resources/private/figurehead/ui/ui.grid.html"
        if let contents = try? String(contentsOf:URL(fileURLWithPath: fileOnDiskPath)) {
            if contents.hasPrefix("#define PAMPHLET_PREPROCESSOR") {
                do {
                    let task = Process()
